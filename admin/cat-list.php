    ...
    <body>
        ...
        <div id="main">
            <header class="w3-container w3-black">
                ...
                <center><p style="font-size: 50px;" class="w3-text-shadow">Categories List</p></center>
            </header>
        <?php
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3"><a href="cat-del.php?id=<?php echo $row['category_id']?>;"  class="w3-btn w3-hover-red" id="right-btn">Delete</a>
                            <a href="cat-edit.php?id=<?php echo $row['category_id']?>;" class="w3-btn w3-hover-blue">Edit</a></div>
                        </div>
                        <div class="ui inverted divider"></div>
                    </li>
                    <?php endwhile; ?><br><br>
                    <li><center><a href="cat-new.php" class="w3-btn w3-hover-green" id="add-btn">New Category</a></center></li>
                </ul>
            </div>
        </div>
        <script>
