                ...
                <ul>
                    ...
                    <li title="<?php echo $row['remark'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3"><a href="cat-del.php?id=<?php echo $row['id']?>;"  class="w3-btn w3-hover-red" id="right-btn">Delete</a>
                            <a href="cat-edit.php?id=<?php echo $row['id']?>;" class="w3-btn w3-hover-blue">Edit</a></div>
                        </div>
                        <div class="ui inverted divider"></div>
                    </li>
                    <?php endwhile; ?><br><br>
