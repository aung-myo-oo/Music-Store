...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $id = $_GET['albums_id'];
            $result = mysql_query("SELECT * FROM albums WHERE albums_id=$id");
        ...
        <div id="main">
            <span class="w3-opennav w3-xlarge" onclick="w3_open()" id="openNav">&#9776;</span>
                <div class="w3-card-24" id="card-login-size">
                    ...
                    <form action="albums-update.php" method="post" class="w3-container">

                        <input type="hidden" name="albums_id" value="<?php echo $row['albums_id'] ?>">
