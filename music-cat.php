...
<nav class="w3-sidenav w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidenav"><br>
  ...
  <li><a href="music-cat.php?cat=<?php echo $category['category_id'] ?>" class="w3-padding"><?php echo $category['name']?></a></li>
  <? endwhile; ?>
            ...
            <div class="w3-section w3-border w3-round-xlarge" style="padding:10px">
              <table class="w3-table w3-striped">
                ...
                <tr>
                  ...
                  <td><?php if($row['scategory_id'] == $row['category_id']) echo $row['category_name']?></td>
                </tr>
                <tr>
                  <th width="20%">Size</th>
