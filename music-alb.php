...
<? $alb = mysql_query("select * from albums") ?>
<nav class="w3-sidenav w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidenav"><br>
  ...
  <h3>Music List</h3>
  <? while($albums = mysql_fetch_assoc($alb)):?>
  <li><a href="music-alb.php?alb=<?php echo $albums['albums_id']?>" class="w3-padding"><?php echo $albums['name']?></a></li>
  <? endwhile; ?>
          ...
          <div class="w3-col m6 w3-center">
            <div class="w3-section w3-border w3-round-xlarge" style="padding:10px">
                ...
                <tr>
                  ...
                  <td><?php if($row['salbums_id'] == $row['albums_id']) echo $row['albums_name']?></td>
                </tr>
                <tr>
